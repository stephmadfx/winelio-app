...
export function MobileHeader({
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-winelio-light/80 backdrop-blur-md border-b border-black/5 shadow-sm lg:hidden">
        <div className="flex items-center justify-between px-4 h-16">
          {/* Gauche : avatar + greeting */}
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-winelio-orange to-winelio-amber flex items-center justify-center shadow-sm shrink-0">
      ...
      {menuOpen && (
        <>
          ...
          />
          <div className="fixed top-16 right-0 left-0 z-50 bg-white/90 backdrop-blur-xl border-b border-black/5 shadow-lg lg:hidden">
            <div className="px-4 py-3 space-y-1">
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition-colors ${
                      isActive
                        ...
                        : "text-winelio-gray active:text-winelio-orange active:bg-winelio-orange/5"
                    }`}
                  >
                    <svg
              ...
              <div className="border-t border-black/5 pt-3 mt-2">
                <p className="text-xs text-winelio-gray/60 px-3 mb-2 truncate">{userEmail}</p>
