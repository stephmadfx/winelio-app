...
const navItems = [
  ...
  {
    label: "Cycle de vie pro",
    href: "/gestion-reseau/processus-pro",
    icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7zM18 8l2 2-4 4-2-2",
  },
  {
    label: "Utilisateurs",
