...
export async function notifyRecoRefused(recommendationId: string) {
...
<html lang="fr"><head><meta charset="UTF-8"><title>Recommandation déclinée</title></head>
    ...
    <table width="520" cellpadding="0" cellspacing="0" border="0" style="max-width:520px;width:100%;">
      ...
      <tr><td style="background:#FFFFFF;padding:40px 48px 36px;border-radius:0 0 16px 16px;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          ...
          <tr><td align="center"><p style="margin:0;color:#636E72;font-size:15px;line-height:1.6;"><strong style="color:#2D3436;">${he(proName)}</strong> a décliné votre recommandation pour <strong style="color:#2D3436;">${he(contactName)}</strong>.</p></td></tr>
          <tr><td style="height:24px;font-size:0;line-height:0;">&nbsp;</td></tr>
          <tr><td style="background:#FFF5F0;border-left:3px solid #FF6B35;padding:16px 20px;border-radius:4px;">
            <p style="margin:0;color:#636E72;font-size:14px;line-height:1.6;">Pas d'inquiétude — vous pouvez recommander un autre professionnel pour ce contact. Il suffit de créer une nouvelle recommandation en quelques clics.</p>
          </td></tr>
