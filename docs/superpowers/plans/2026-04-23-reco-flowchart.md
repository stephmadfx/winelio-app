...
const FLOW_NODES_DEF = [
  ...
  // Commissions
  { id: "commissions",     type: "commissions",    label: "💰 Commissions créées automatiquement — 5 niveaux", sublabel: "Recommandeur 60% · Niveaux 1→5 : 3% · Professionnel 1% Gains · Winelio 23%" },
  // Négatifs
