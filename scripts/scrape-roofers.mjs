/**
 * Script de scraping des couvreurs en France (Sans clé d'API Google Places).
 * 
 ...
 *   - Mots-clés : "couvreur"
 *   - Fichier de sortie : outputs/couvreurs_france.csv
 * 
 * Usage:
 *   node scripts/scrape-roofers.mjs
 *   node scripts/scrape-roofers.mjs --limit-cities 3
 *   node scripts/scrape-roofers.mjs --city Lille
 *   node scripts/scrape-roofers.mjs --skip-puppeteer-fallback
 */
...
async function main() {
  console.log("🚀 Lancement du scraping des couvreurs (SANS CLÉ API)");
